    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.TextField(blank=True, choices=[('assignment', 'Quiz'), ('exam', 'Exam'), ('practice', 'Practice Quiz')])),
                ...
                ('draft', models.BooleanField(blank=True, default=False, help_text='If yes, the assessment is not displayed in the assessment list and can only be taken by users who can edit assessments.', verbose_name='Draft')),
